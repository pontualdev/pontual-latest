export const environment = {
    production: false,
    firebaseConfig: {
        apiKey: "AIzaSyCgNi_kR8cgSrLRAWCI-fyp2Jiy6IPCAkQ",
        authDomain: "pontual-news.firebaseapp.com",
        projectId: "pontual-news",
    ...
    newsletter: {
        endpoint: 'http://pontual.host/wp-json/newsletter/v2',
