...
import { PostResolver } from '@core/services/resolvers/post.resolver';
...
const routes: Routes = [
  ...
  { path: 'post/:slug', loadChildren: () => import('./feature-modules/post/post.module').then(m => m.PostModule), resolve: { post: PostResolver } },
